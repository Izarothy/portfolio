...
const Description = () => {
  return (
    <article className="flex min-h-screen w-full flex-col items-center justify-center gap-4  text-center ">
      <h2 className=" text-3xl font-bold">A few words about myself</h2>
      <p className="  max-w-4xl px-8 text-left text-lg text-gray-200 lg:px-0">
